********************************************************************************
* Importing and cleaning self-report baseline survey data for Spring 2019 (Summer 2018)
* 
...
import delimited "Raw excel data/Post-Simulator Baseline Student Survey- Summer 2018_January 22, 2020_16.58.csv", bindquote(strict) varnames(1)  maxquotedrows(100) clear 
...
rename	q1			email
rename	q4_1		sim_fbsk
rename	q5			sim_txt_fbsk
...
replace email="blt9q@virginia.edu" if email=="blt9q@gmail.com"
replace email="ecu2ug@virginia.edu" if email=="ecu2ug@gmail.com"
replace email="bbp5rr@virginia.edu" if email=="bbp5rr@virgnia.edu"

* Dropping duplicate observations	
drop if email=="blt9q@virginia.edu" & startdate=="2018-06-14 14:52:51"
drop startdate
...
destring sim_fbsk sim_cmsk, replace
...
* Saving dataset 
save "Working STATA files/Summer2018_Baseline_Post-Survey_Cleaned.dta", replace

* Importing data for re-dos 
import delimited "Raw excel data/Post-Simulator Baseline Student Survey (only for Redos)- Summer 2018 - Copy_January 23, 2020_07.22.csv", bindquote(strict) varnames(1)  maxquotedrows(100) clear
...
* Correcting email ids
replace email="krv2td@virginia.edu" if email=="kr2tvd@virginia.edu"
drop startdate
...
* Saving dataset 
save "Working STATA files/Summer2018_Baseline_Redos_Post-Survey_Cleaned.dta", replace

* Merging two datasets
use "Working STATA files/Summer2018_Baseline_Post-Survey_Cleaned.dta", clear
merge 1:1 email using  "Working STATA files/Summer2018_Baseline_Redos_Post-Survey_Cleaned.dta", update replace
drop _merge

* Saving final dataset
save "Working STATA files/Summer2018_Baseline_Post-Survey_Merged_Cleaned.dta", replace
