...
import chalicelib.DocSim_class as DocSim_class
import boto3
app = Chalice(app_name='sera-nlp')
s3 = boto3.client('s3')
## Change before prod
LOCAL_DEV = False
...
@app.on_s3_event(bucket='sera-nlp-raw-data',
...
def on_raw_data_upload(event):
    ...
    loadTextData('spring_2018', prefix)
    loadTextData('spring_2019', prefix)
    print(prefix)
