...
BEHAVIOR_COLUMNS = list(zip(['tot_oc', 'tot_ac', 'tot_sp', 'tot_cu', 'total_nb_se', 'tot_ti', 'tot_su'],[BEHAVIOR_OCCURED_COLUMNS,
                                                                                                     BEHAVIOR_ACKNOWLEDGED_COLUMNS,
                                                                                                     BEHAVIOR_SPECIFIC_COLUMNS,
                                                                                                     BEHAVIOR_CUTOFF_COLUMNS,
                                                                                                     BEHAVIOR_CUTOFF_REASON_COLUMNS,
...
CALCULATED_COLUMNS = list(zip(['score_dc_avg', 'prop_beh_ack', 'ti_dc_avg', 'prop_redirect', 'su_dc_avg'], [['score'], ['tot_ac', 'tot_oc'], ['tot_ti', 'tot_ac'], ['tot_sp', 'tot_ac'], ['tot_su', 'tot_ac']]))
