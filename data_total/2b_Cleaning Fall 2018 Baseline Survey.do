********************************************************************************
* Importing and cleaning self-report baseline survey data for Spring 2019 (Fall 2018)
* 
...
import delimited "Raw excel data/Post-Simulator Baseline Student Survey- Fall 2018_July 24, 2019_15.43.csv", bindquote(strict) varnames(1)  maxquotedrows(100) clear 
...
replace email="ahm4kv@virginia.edu" if email=="ahm4kv"
replace email="kmh3yj@virginia.edu" if email=="kmh3yj"
replace email="oce7ph@virginia.edu" if email=="oce7ph"

* Dropping duplicate observations	
drop if email=="ab2dx@virginia.edu" & startdate=="2018-10-03 07:33:46"
drop if email=="bh2vy@virginia.edu" & startdate=="2018-10-01 10:00:58"
drop if email=="ekh2wb@virginia.edu" & startdate=="2018-09-20 17:59:01"
drop if email=="klj9ww@virginia.edu" & startdate=="2018-10-03 15:47:09"
drop if email=="mca5hu@virginia.edu" & startdate=="2018-09-24 07:59:39"
drop if email=="nf2ke@virginia.edu" & startdate=="2018-09-19 09:49:49"
drop startdate
...
* Saving dataset 
save "Working STATA files/Fall2018_Baseline_Post-Survey_Cleaned.dta", replace
