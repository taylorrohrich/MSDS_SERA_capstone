...
import delimited "Raw excel data/Post-Simulator Student Survey Round 2- Spring 2019_July 24, 2019_15.24.csv", bindquote(strict) varnames(1)  maxquotedrows(100) clear 
...
* Saving dataset 
save "Working STATA files/Spring2019_Exit_Post-Survey_Cleaned.dta", replace
